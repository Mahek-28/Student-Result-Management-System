...
class resultClass:
    def __init__(self,root):
       ...
       #=========variables=============
        ...
        self.roll_list=[]
        #fun call fatch roll no by student 
        self.fetch_roll()
        ...
        btn_clear=Button(self.root,text='Clear',font=("times new roman",15),bg="lightgray",activebackground="lightgray",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
         ...
         #=========Image Content_Window==========
        self.bg_img=Image.open("result_Image.png") 
    ...
    def search(self):
        ...
        try:
            ...
            row=cur.fetchone()
            if row!=None:  # if no any students then set details which is given by user
