...
def create_db():
    ...
    cur=con.cursor()
    #======Creating Course Table for DataBase=======
    cur.execute("CREATE TABLE IF NOT EXISTS course (cid INTEGER PRIMARY KEY AUTOINCREMENT,name text,duration text,charges text,description text)")
    con.commit()
      
    #======Creating Student Table for DataBase=======
    ...
    #======Creating result Table for DataBase=======
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS user(eid INTEGER PRIMARY KEY AUTOINCREMENT,f_name text,l_name text,contact text,email text,question text,answer text,password text)")
    con.commit()
